...
DROP POLICY IF EXISTS "Agents can view own applications" ON public.applications;
CREATE POLICY "Agents can view own applications" ON public.applications FOR SELECT
...
DROP POLICY IF EXISTS "Agents can view client profiles" ON public.profiles;
CREATE POLICY "Agents can view client profiles" ON public.profiles FOR SELECT
    USING (
        EXISTS (

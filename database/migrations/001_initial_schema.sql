...
-- ================================================================
-- This migration sets up the complete database schema for ACSS South Sudan
...
CREATE INDEX IF NOT EXISTS idx_application_items_application_id ON application_items(application_id);
CREATE INDEX IF NOT EXISTS idx_application_items_hs_code ON application_items(hs_code);
...
CREATE INDEX IF NOT EXISTS idx_tariff_codes_hs_code ON tariff_codes(hs_code);
CREATE INDEX IF NOT EXISTS idx_tariff_codes_category ON tariff_codes(category);
CREATE INDEX IF NOT EXISTS idx_tariff_codes_is_active ON tariff_codes(is_active);
